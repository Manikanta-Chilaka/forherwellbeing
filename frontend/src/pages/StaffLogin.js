...
export default function StaffLogin() {
  ...
  async function handleSubmit(e) {
    ...
    if (profile.role === 'staff') {
      ...
      setServer('Unauthorised role. Please contact your administrator.');
      await supabase.auth.signOut();
    }
  }
    ...
    <div className="sl-page">
      ...
      <div className="sl-panel">
        <div className="sl-panel__content">
          ...
          <h2 className="sl-panel__headline">
            Staff Portal
          </h2>
          <p className="sl-panel__sub">
            Securely manage patient consultations, records, and appointments from one place.
          </p>
      ...
      <div className="sl-right">
        <div className="sl-card">
          ...
          <div className="sl-card__header">
            <h1 className="sl-card__title">Staff Sign In</h1>
            <p className="sl-card__sub">Enter your credentials to access the portal</p>
          </div>
          ...
          <form className="sl-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className={`sl-field ${errors.email ? 'sl-field--error' : ''}`}>
              ...
              <div className="sl-input-wrap">
                ...
                <input
                  ...
                  type="email"
                  className="sl-input"
                  placeholder="staff@forherwellbeing.com"
                  value={form.email}
              ...
              {errors.email && (
                <p className="sl-error" id="email-error" role="alert">{errors.email}</p>
              )}
            </div>
            ...
            <div className={`sl-field ${errors.password ? 'sl-field--error' : ''}`}>
              ...
              {errors.password && (
                <p className="sl-error" id="password-error" role="alert">{errors.password}</p>
              )}
            </div>
          ...
          <p className="sl-card__footer">
            This portal is restricted to authorised staff only.<br />
